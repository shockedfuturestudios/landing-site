  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          Crafting immersive gaming experiences that push boundaries and challenge conventions. 
          We're a small team with big dreams, building the future of indie gaming.
        </motion.p>

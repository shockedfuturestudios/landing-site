...
export function LogoLight({ className = "w-auto h-24" }: { className?: string }) {
  return (
    <svg viewBox="0 0 640 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <circle cx="73.5" cy="60.5" r="41.5" stroke="black" strokeWidth="3"></circle>
      ...
      <text x="125" y="75" fill="black" className="tracking-tight"><tspan fontSize="35" fontWeight="700">SHOCKED</tspan></text>

      <text x="292" y="75" fill="black" className="tracking-wide"><tspan fontSize="35" fontWeight="700" letterSpacing="2">FUTURE</tspan></text>

      <text x="442" y="75" fill="black" className="tracking-wide"><tspan fontSize="35" fontWeight="700" letterSpacing="2">STUDIOS</tspan></text>
    </svg>
  );
}
...
export function LogoNoTypographyLight({ className = "w-auto h-24" }: { className?: string }) {
  return (
    <svg width="1024" height="1024" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M511.5 109C734.365 109 915 289.447 915 512C915 734.553 734.365 915 511.5 915C288.635 915 108 734.553 108 512C108 289.447 288.635 109 511.5 109Z" stroke="black" strokeWidth="32" />
...
export function LogoDark({ className = "w-auto h-24" }: { className?: string }) {
  return (
    <svg viewBox="0 0 640 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <circle cx="73.5" cy="60.5" r="41.5" stroke="white" strokeWidth="3"></circle>
      ...
      <text x="125" y="75" fill="white" className="tracking-tight"><tspan fontSize="35" fontWeight="700">SHOCKED</tspan></text>

      <text x="292" y="75" fill="white" className="tracking-wide"><tspan fontSize="35" fontWeight="700" letterSpacing="2">FUTURE</tspan></text>

      <text x="442" y="75" fill="white" className="tracking-wide"><tspan fontSize="35" fontWeight="700" letterSpacing="2">STUDIOS</tspan></text>
    </svg>
  );
}
...
export function LogoNoTypographyDark({ className = "w-auto h-24" }: { className?: string }) {
  return (
    ...
    <svg width="1024" height="1024" viewBox="0 0 1024 1024" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M511.5 109C734.365 109 915 289.447 915 512C915 734.553 734.365 915 511.5 915C288.635 915 108 734.553 108 512C108 289.447 288.635 109 511.5 109Z" stroke="white" strokeWidth="32" />
